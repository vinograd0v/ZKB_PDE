...
\begin{align*}
0 &\leq\left\|f(x)-\sum_{\substack{k\in \Z^{n}\\ |k|\leq N}}\widehat{f}(k)e^{ik\cdot x}\right\|^{2}_2\\
&= || f||_2^{2}+ \left\| \sum_{\substack{k\in \Z^{n}\\|k|\leq N}} \widehat{f}(k)e^{ik\cdot x}\right\|_2^{2}- 2 \Re\left(f(x)\left|\sum_{\substack{k \in \Z^{n}\\ |k|\leq N}} \widehat{f}(k) e^{ik\cdot x}\right.\right)\\
&= || f||_2^{2}+ \left\| \sum_{\substack{k,m\in \Z^{n}\\ |k|,|m|\leq N}} \widehat{f}(k)\overline{\widehat{f}(m)}(e^{ik\cdot x}|e^{im\cdot x})\right\|_2^{2}- 2 \Re\left(\sum_{\substack{k \in \Z^{n}\\ |k|\leq N}} \overline{\widehat{f}(k)} \left(\widehat{f}(k) |e^{ik\cdot x}\right)\right)\\
&= || f||_2^{2}+ \sum_{\substack{k\in \Z^{n}\\ |k|\leq N}} (2\pi)^{n}\left|\widehat{f}(k)\right|^{2}-2 \sum_{\substack{k\in \Z^{n}\\ |k|\leq N}}(2\pi)^n\left|\widehat{f}(k)\right|^{2}\\
&= || f||_2^{2}- \sum_{\substack{k\in \Z^{n}\\ |k|\leq N}}(2\pi)^n\left|\widehat{f}(k)\right|^{2}
\end{align*}

Colocando los resultados anteriores, entonces
\begin{align*}
0 &\leq|| f||_2^{2}-(2\pi)^n \sum_{\substack{k\in \Z^{n}\\ |k|\leq N}}\left|\widehat{f}(k)\right|^{2}
\end{align*}
Por lo cual 
\begin{align*}
\sum_{\substack{k\in \Z^{n}\\ |k|\leq N}}\left|\widehat{f}(k)\right|^{2} &\leq\dfrac{1}{(2\pi)^n}|| f||_2^{2}
\end{align*}
Luego tomando el límite cuando $N\rightarrow \infty$, entonces
\begin{align*}
\sum_{\substack{k\in \Z^{n}}}\left|\widehat{f}(k)\right|^{2} &\leq\dfrac{1}{(2\pi)^n}|| f||_2^{2}
\end{align*}
\end{proof}
...
$$
\|\widehat{f}\|_2^2=\sum_{k \in \mathbb{Z}^n}|\widehat{f}(k)|^2=\frac{1}{(2 \pi)^n} \int_{[-\pi, \pi]^n}|f(x)|^2 d x=\frac{1}{(2 \pi)^n}\|f\|_2^2.
$$
...
$$
(\widehat{f} \mid \widehat{g})=\sum_{k \in \mathbb{Z}^n} \widehat{f}(k) \overline{\widehat{g}(k)}=\frac{1}{(2 \pi)^n} \int_{[-\pi, \pi]^n} f(x) \overline{g(x)} d x=\frac{1}{(2 \pi)^n}(f \mid g).
$$
\end{theorem}
...
$$\|f\|_2^2=\int_{[-\pi, \pi]^n}|f(x)|^2 d x<\infty.$$
\end{definition}
