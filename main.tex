...
$$
\|f_n - f_m\|^2_{L^2(\T^{n})} = (2\pi)^{n} \|\hat{f}_n - \hat{f}_m\|^2_{2},
$$
...
$$
|\widehat{f}_n(k) - \alpha_k|^2 \leq \sum_{k=-\infty}^{\infty} |\widehat{f}_n(k) - \alpha_k|^2 = \|\hat{f}_n - \{\alpha_k\}\|^2_{2} \to 0 \quad \text{cuando} \quad n \to \infty.
$$
