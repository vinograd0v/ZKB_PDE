...
\end{aligned}
$$
Donde $C > 0$, ya que $C_s, c > 0$. Además, $C$ no depende de la elección de $f$ y $g$. Adicionalmente, como $f, g \in H^s(\mathbb{T}^n)$, la desigualdad anterior nos da que $fg \in H^s(\mathbb{T}^n)$. Esto completa la prueba.
