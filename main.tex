...
A continuación presentamos el espacio $L^2(\T^n)$, anteriormente,  en el Teorema \ref{bessel} habíamos definido la norma $\|\|_{L^2}$ como una notación, sin presentar una definición de este espacio...
...
\textcolor{red}{Aquí hay que definir los espacios y su producto interno...}\\
