...
\begin{align*}
    \widehat{\partial^{\alpha}f}(k)&=\widehat{\partial_{k_j}f}(k)\\
    &=\dfrac{1}{(2\pi)^n}\int_{\T^n}\partial_{k_j}f(k)e^{-ik\cdot x}\\
    &=-\dfrac{1}{(2\pi)^n}\int_{\T^n}(-ik_j)f(k)e^{-ik\cdot x}\\
    &=\dfrac{i^{|\alpha|}k^{\alpha}}{(2\pi)^n}\int_{\T^n}f(k)e^{-ik\cdot x}\\
    &=i^{|\alpha|}k^{\alpha}\hat{f}(k)
.\end{align*}
