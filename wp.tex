...
\begin{itemize}
       ...
       \textcolor{blue}{El Ivan es un pedante}
       \\
       ...
       \end{align*}
       Luego basta con probar que cuando $t\to s$ cada sumando se hace 0. Primero veamos el caso donde $s=0$, note que la definición de la norma en $H^s(\T^n)$ y la proposición (\ref{FourierUt}) 
       \begin{align*}
       ...
       \end{align*}
       Así como por hipótesis $\{\langle k\rangle^s\hat{u}_0(k)\}\in\ell^2(\Z^n)$ concluimos que $\{\langle k\rangle^s(e^{(ik_1|k|^2-|k^2|)t}-1)\hat{u}_0(k)\}\in\ell^2(\Z^n)$ por M de Weierstrass, Así tenemos que
       ...
       \begin{align*}
           ...
           &\leq 4|\langle k\rangle^s\hat{u}_0(k)|^2
       \end{align*}
       y nuevamente por M de Weierstrass podemos ingresar el limite, es decir
       ...
       \begin{align*}
             ...
             &\leq\int_t^s\|v^3(t^\prime)\|_{H^s}dt^\prime+\int_t^s\|v^3(t^\prime)\|_{H^s}\,dt^\prime\to 0.
         \end{align*} 
         Cuando $t\to s$.\\
